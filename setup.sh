...
echo "${BLUE} /\$\$\$\$\$\$\$\$           /\$\$       /\$\$             /\$\$             ${NC}";
echo "${BLUE}| \$\$_____/          |__/      | \$\$            | \$\$             ${NC}";
echo "${BLUE}| \$\$        /\$\$\$\$\$\$  /\$\$  /\$\$\$\$\$\$\$  /\$\$\$\$\$\$  /\$\$\$\$\$\$   /\$\$\$\$\$\$\$${NC}";
echo "${BLUE}| \$\$\$\$\$    /\$\$__  \$\$| \$\$ /\$\$__  \$\$ /\$\$__  \$\$|_  \$\$_/  /\$\$_____/${NC}";
echo "${BLUE}| \$\$__/   | \$\$  \\ \$\$| \$\$| \$\$  | \$\$| \$\$  \\ \$\$  | \$\$   |  \$\$\$\$\$\$ ${NC}";
echo "${BLUE}| \$\$      | \$\$  | \$\$| \$\$| \$\$  | \$\$| \$\$  | \$\$  | \$\$ /\$\$\\____  \$\$${NC}";
echo "${BLUE}| \$\$\$\$\$\$\$\$| \$\$\$\$\$\$\$/| \$\$|  \$\$\$\$\$\$\$|  \$\$\$\$\$\$/  |  \$\$\$\$//\$\$\$\$\$\$\$/${NC}";
echo "${BLUE}|________/| \$\$____/ |__/ \\_______/ \\______/    \\___/ |_______/ ${NC}";
echo "${BLUE}          | \$\$                                                 ${NC}";
echo "${BLUE}          | \$\$                                                 ${NC}";
echo "${BLUE}          |__/                                                 ${NC}";
...
if [ ! -d "$WALLPAPERS" ]; then
    git clone "$REPO_WALLPAPER" "$WALLPAPERS" && rm -rf "$WALLPAPERS/.git"
fi
printf "[${GREEN}OK${NC}]\n"
